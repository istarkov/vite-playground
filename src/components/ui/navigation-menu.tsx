...
const allowAnims = true;
const anims = (str: string) => (allowAnims ? str : '');
...
const navigationMenuTriggerStyle = cva(
  'inline-flex h-10 w-max items-center justify-center rounded-md bg-background px-4 py-2  ' +
    'text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent  ' +
